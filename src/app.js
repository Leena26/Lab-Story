...
function moreAboutKaren(parents, numberOfSiblings, isNuclearFamily){
    if(typeof(parents)=="string" && typeof(numberOfSiblings)=="number" && typeof(isNuclearFamily)=="boolean")
        return true;
    else
        return false;
}
